...
ALTER TABLE public.modulos
    ADD COLUMN IF NOT EXISTS importancia enum_importancia_modulo DEFAULT 'Base';

-- 3. Add comment to column
COMMENT ON COLUMN public.modulos.importancia IS 'Nível de importância do módulo. Usado no modo "Mais Cobrados" dos flashcards para priorizar conteúdo mais cobrado nas provas. Valores: Alta, Media, Baixa, Base (padrão)';
...
-- 5. Update existing modules without importancia to 'Base' (if any)
UPDATE public.modulos
SET importancia = 'Base'
