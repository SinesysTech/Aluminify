-- Fix: importar_cronograma_aulas should respect aulas_prioridade_check (1..5)
-- Date: 2026-01-12
--
-- O banco tem constraint: aulas_prioridade_check => prioridade entre 1 e 5.
-- No import, valores 0 (ou fora do range) devem virar NULL.
