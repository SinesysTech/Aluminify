...
-- Criar algumas conversas de exemplo (opcional - comentado)
-- INSERT INTO chat_conversations (user_id, session_id, title, is_active)
-- VALUES
--   (auth.uid(), 'session-example-1', 'Primeira Conversa', true),
--   (auth.uid(), 'session-example-2', 'Aprendendo SQL', false);
